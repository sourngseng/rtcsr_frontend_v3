        ...
        <div class="row align-items-center">
            <div class="col-lg-4">
                <div class="testimonials-title">
                    <h2 class="title">ការវាយតម្លៃរបស់សិស្ស</h2>
                    <span class="line"></span>
                    <p>ភាពជឿជាក់របស់សិស្សនិស្សតដែលបានមកសិក្សាជំនាញបច្ចេកទេសទីនេះ។
                        បងប្អូនអាចជឿទុកចិត្តចំពោះគុណភាពបណ្តុះបណ្តាលរបស់យើងបាន!</p>
                </div>
            </div>
            <div class="col-lg-8">
