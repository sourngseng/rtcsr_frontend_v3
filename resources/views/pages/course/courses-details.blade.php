        ...
        <div class="row flex-row-reverse">
            <div class="col-lg-9">
                <div class="courses-details-content mt-50">
                    <img src="{{ asset('frontend') }}/assets/images/courses-details.webp" width="845" height="533"
                        alt="Course Details">

                    <h2 class="title">Bachelor of Business Administration</h2>

                    <p>Even slightly believable. If you are going use a passage of Lorem Ipsum need equal blame belongs
                    ...
                    <p>Bachelor of Business Administration(BBA) If you are going use a passage of Lorem Ipsum need equal
                        ...
                        distinguish. <br> <br> Bachelor of Business Administration(BBA) If you are going use a passage
                        of Lorem Ipsum need equal blame belongs to those who fail in their duty through weakness of
                        will, which is the same as saying through shrinking from toil and pain. These cases are
                        perfectly simple and easy to distinguish omnis dolor repellendus. Temporibus autem quibusdam et
                        aut officiis debitis aut rerum necessitatibus sae pe eveniet ut et voluptates repudiandae sint
                        et molestiae.</p>

                    <ul class="courses-details-list">
                        <li>
                            <i class="far fa-check-circle"></i>
                            <p>Bachelor of Business Administration(BBA) If you are going use a passage of blame belongs
                                to those who fail in their duty through weakness </p>
                        </li>
                        <li>
                            <i class="far fa-check-circle"></i>
                            <p>Bachelor of Business Administration(BBA) If you are going use a passage of blame belongs
                ...
                <div class="courses-details-tab">
                    <ul class="nav nav-justified"">
                            <li class=" nav-item"><a class="active" data-bs-toggle="tab" href="#benefit">Benefit</a>
                        </li>
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="benefit">
                            <div class="benefit-content">
                                <p>Bachelor of Business Administration(BBA) If you are going use a passage of Lorem
                                    Ipsum need equal blame belongs to those who fail in their duty through weakness of
                                ...
                                <ul class="courses-details-list">
                                    <li>
                                        <i class="far fa-check-circle"></i>
                                        <p>Bachelor of Business Administration(BBA) If you are going use a passage of
                                            blame belongs to those who fail in their duty through weakness </p>
                                    </li>
                                    <li>
                                        <i class="far fa-check-circle"></i>
                                        <p>Bachelor of Business Administration(BBA) If you are going use a passage of
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <div class="single-curriculum">
                                            ...
                                            <ul class="curriculum-list">
                                                <li><a href="#"><i class="fal fa-book"></i> Lessons 1.1:
                                                        Introduction</a></li>
                                                <li><a href="#"><i class="fal fa-book"></i> Lessons 1.2: Know about
                                                        BBA</a></li>
                                                <li><a href="#"><i class="fal fa-book"></i> Lessons 1.3: How to
                                                        improve</a></li>
                                                <li><a href="#"><i class="fal fa-book"></i> Lessons 1.4: Business
                                                        Math</a></li>
                                                <li><a href="#"><i class="fal fa-book"></i> Lessons 1.1: Social
                                                        Marketing</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="single-teacher mt-30 text-center">
                                            ...
                                            <div class="teacher-image">
                                                <a href="teacher-details.html">
                                                    <img src="{{ asset('frontend') }}/assets/images/teachers/teacher-1.webp"
                                                        alt="teacher">
                                                </a>
                                            </div>
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <div class="single-teacher mt-30 text-center">
                                            ...
                                            <div class="teacher-image">
                                                <a href="teacher-details.html">
                                                    <img src="{{ asset('frontend') }}/assets/images/teachers/teacher-2.webp"
                                                        alt="teacher">
                                                </a>
                                            </div>
                                            <div class="teacher-content">
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <div class="single-teacher mt-30 text-center">
                                            ...
                                            <div class="teacher-image">
                                                <a href="teacher-details.html">
                                                    <img src="{{ asset('frontend') }}/assets/images/teachers/teacher-3.webp"
                                                        alt="teacher">
                                                </a>
                                            </div>
                                            <div class="teacher-content">
            ...
            <div class="col-lg-3">
                <div class="courses-sidebar pt-20">
                    ...
                    <div class="courses-sidebar-banner mt-30">
                        <a href="#">
                            <img src="{{ asset('frontend') }}/assets/images/banner.webp" width="270" height="310"
                                alt="Banner">
                        </a>
                    </div>
                </div>
